...
public class Exercise5Test extends PetDomainForKata
{
    ...
    {
        final PartitionMutableList<Person> partitionMutableList
    ...
    {
        final Pet oldestPet = people.flatCollect(Person::getPets).maxBy(pet -> pet.getAge());
    ...
    {
        final double averagePetAge = people.flatCollect(Person::getPets)
    ...
    public void refactorToEclipseCollections()
    {
        ...
        Assert.assertEquals(IntSets.mutable.with(1, 2, 3, 4), petAges.collectInt(i -> i));
